    ...
    return (
        <div>
            ...
            <Row id="photos" className="my-4">
                <Col lg={12}>
                    <h2>Photos</h2>
                    <Image src="https://template-riptide.s3.us-west-1.amazonaws.com/home-sunset-OLD-v2.jpg" alt="The Riptide" fluid />
            ...
            <Row className="my-4">
                <Col lg={12}>
                    <Image src="https://template-riptide.s3.us-west-1.amazonaws.com/home-carville-OLD-v2.jpg" alt="Sunset Carville" fluid />
